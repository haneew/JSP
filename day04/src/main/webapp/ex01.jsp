...
<table>
	...
	<tr>
		...
		<td>attribute 저장 가능,주로 로그인 처리에 사용한다</td>
	</tr>
	<tr>
		<td>pageContext</td>
...
// 		out.print("<p>exception : " + (pageContext.getException() == exception) + "<p>");
	...
	<h3>EL Tag에서 pageContext만으로 나머지 내장객체에 접근하는 역활을 수행한다</h3>
	
	<h4>request.getContextPth() : ${pageContext.request.contextPath }</h4>
	<h4>request.getContextPth() : <%=request.getContextPath() %></h4>
