...
<table>
	<tr>
		...
		<td>
			<ul>
				<li>클라이언트가 새로운 요청을 보내기 떄문에, 현재 서버가 아닌 다른 주소도 이동 가능하다</li>
				<li>클라이언트가 직업 요청을 보내기 때문에, 브라우저 주소창의 주소가 변경된다</li>
...
<fieldset>
	...
	<form>
		<input type="text" name="forwardURL" placeholder="포워드 주소 입력">
		<button>포워드</button>
	</form>
</fieldset>
