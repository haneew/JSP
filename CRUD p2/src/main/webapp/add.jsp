...
<section>
	<form action="add-action.jsp">
		<p><input type="text" name="artist_name" placeholder="아티스트"></p>
		<p><input type="text" name="album_name" placeholder="앨범"></p>
		<p><input type="text" name="name" placeholder="곡명"></p>
		...
		<p>
			<textarea name="lyrics" placeholder="가사" rows="10" cols="80" style="resize: none;"></textarea>
		</p>
