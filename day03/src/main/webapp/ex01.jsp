...
<%!
	...
	private int count = 0;				// 진행하는 동안 횟수가 유지되어야 하기 떄문에
	private int cpu;					// 입력마다 값이 바뀌면 안되니까(유지되어야 한다)
	
// 	String test = request;  선언부에서는 request및 response에 접근 불가하다
...
<%
	...
	String input = request.getParameter("user");		// 입력값은 매번 새로 변한다
